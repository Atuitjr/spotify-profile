...
const NavLink = (props) => react_1.default.createElement(router_1.Link, Object.assign({ getProps: isActive }, props));
const Nav = () => (react_1.default.createElement(Container, null,
