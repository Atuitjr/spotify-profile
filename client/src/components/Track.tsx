...
import { getTrackInfo } from "../spotify/spotify";
...
class Track extends Component<RouteComponentProps, any> {
	static propTypes = {
	...
	state: {
		track: null | any;
		audioAnalysis: null | any;
		audioFeatures: null | any;
	} = {
		track: null,
		audioAnalysis: null,
		audioFeatures: null,
