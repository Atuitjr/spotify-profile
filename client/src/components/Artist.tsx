...
import { formatWithCommas, catchErrors } from "../utils/utils";
import {
	getArtist,
	followArtist,
...
`;
const FollowButton = styled.button<{ isFollowing: any }>`
	${mixins.greenButton};
	margin-top: 50px;
	padding: 12px 50px;
	...
	border: 1px solid
		${(props) => (props.isFollowing ? "white" : "transparent")};
...
class Artist extends Component<RouteComponentProps, any> {
	static propTypes = {
		artistId: PropTypes.string,
	};

	state: { artist: null | any; isFollowing: any | null } = {
		artist: null,
		isFollowing: null,
	};
